...
export const DEFAULT_CONSTELLATIONS = [
  ...
  },
  {
    ...
    star_nodes: [
      ...
      { id: 5, label: 'Tejat',   x: 0.25, y: 0.55, next_node_id: null, hitbox_radius: 0.055 },
    ],
    fake_nodes: [
  ...
  },
  {
    ...
    star_nodes: [
      ...
      { id: 6, label: 'Alcyone',    x: 0.58, y: 0.20, next_node_id: null, hitbox_radius: 0.055 },
    ],
    fake_nodes: [
  ...
  },
  {
    ...
    star_nodes: [
      ...
      { id: 6, label: 'Girtab',   x: 0.74, y: 0.48, next_node_id: null, hitbox_radius: 0.055 },
    ],
    fake_nodes: [
  ...
  },
  {
    ...
    star_nodes: [
      ...
      { id: 4, label: 'Segin',     x: 0.82, y: 0.42, next_node_id: null, hitbox_radius: 0.055 },
    ],
    fake_nodes: [
  ...
  },
  {
    ...
    star_nodes: [
      ...
      { id: 4, label: 'Delta Cygni', x: 0.72, y: 0.48, next_node_id: null, hitbox_radius: 0.055 },
    ],
    fake_nodes: [
  ...
  },
  {
    ...
    star_nodes: [
      ...
      { id: 8, label: 'Tania',   x: 0.45, y: 0.72, next_node_id: null, hitbox_radius: 0.055 },
    ],
    fake_nodes: [
  ...
  },
  {
    ...
    star_nodes: [
      ...
      { id: 5, label: 'Aludra',    x: 0.35, y: 0.78, next_node_id: null, hitbox_radius: 0.055 },
    ],
    fake_nodes: [
